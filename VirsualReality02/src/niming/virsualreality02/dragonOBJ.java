 ...
 *
 */
public class dragonOBJ extends MyActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        // Assign our renderer.
        mGLSurfaceView.setRenderer(new ScreenRenderer(dragonOBJ.this));	//画cube
...
//        mGLSurfaceView.setFocusableInTouchMode(true);//设置为可触控  
	...
	private class ScreenRenderer implements GLSurfaceView.Renderer{
		...
		public ScreenRenderer(Context context) {//添加数据通道,
			...
			/*OBJ文件导入*/
			obj = new ObjParser(context, "niming.virsualreality02:raw/dragon_obj", true);
			obj.parse();//解析OBJ文件
...
//			texture1 = TextureHelper.loadTexture(context, R.drawable.wl, true);//四只小蜜蜂
			texture1 = TextureHelper.loadTexture(context, R.drawable.checker2);//棋盘
			texture2 = TextureHelper.loadTexture(context, R.drawable.camaro, true);//汽车
		}
		@Override
...
//	        Matrix.setLookAtM(viewMatrix, 0, -1f, 0f, 2.2f, 0f, 0f, -5f, 0f, 1f, 0f);
			...
			scaleM(modelMatrix, 0, 0.1f, 0.1f, 0.1f);//dragon太大了
