...
public class SheepOBJ extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        // Assign our renderer.
        mGLSurfaceView.setRenderer(new HandlerScreenRenderer(SheepOBJ.this, "niming.virsualreality02:raw/ram_obj"));	//画cube
...
//	        mGLSurfaceView.setFocusableInTouchMode(true);//设置为可触控  
	...
	private class HandlerScreenRenderer implements GLSurfaceView.Renderer{
		...
		public HandlerScreenRenderer(Context context, String objResource) {//添加数据通道,
			...
			/*检测数据是否导入*/
//			Log.d("ParseObjectData.vertices", ""+car.vertices.size());
//			Log.d("ParseObjectData.textures", ""+car.texCoords.size());
//			Log.d("ParseObjectData.normals", ""+car.normals.size());
...
//				glEnableVertexAttribArray(aColorLocation);
			...
			texture2 = TextureHelper.loadTexture(context, R.drawable.char_ram_col);//绵羊
		}
		@Override
...
//		        Matrix.setLookAtM(viewMatrix, 0, -1f, 0f, 2.2f, 0f, 0f, -5f, 0f, 1f, 0f);
			...
			scaleM(modelMatrix, 0, 3f, 3f, 3f);
//				rotateM(modelMatrix, 0, angleInDegrees, 1f, 0f, 0f);//绕x轴旋转angleInDegrees
				rotateM(modelMatrix, 0, angleInDegrees, 1f, 1f, 0f);//绕xy轴旋转angleInDegrees
