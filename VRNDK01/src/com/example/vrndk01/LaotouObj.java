...
public class LaotouObj extends MyActivity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//渲染器对象
		final MyRenderer2 renderer = new MyRenderer2(LaotouObj.this,  "com.example.vrndk01:raw/laotou_obj",  R.drawable.laotou);
		renderer.setTYPE(Constant.TRIANGLES);
		renderer.setScale(0.18f, 0.18f, 0.18f);
//		renderer.setTranslate(0.0f, -1.0f, 0.0f);
		renderer.setTranslate(0.0f, -3.5f, -2.0f);
