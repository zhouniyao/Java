	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				case 0:
					//激活dragon例子
					intent = new Intent(MainActivity.this, CubeObj.class);
					startActivity(intent);
					break;
				case 1:
					startActivity(new Intent(MainActivity.this, SheepObj.class));//无纹理测试
//					try {
//						Thread.sleep(3000);
...
//					}
					break;
				case 2:
					startActivity(new Intent(MainActivity.this, CarObj.class));//
//					try {
//						Thread.sleep(3000);
//					} catch (InterruptedException e) {
//						// TODO Auto-generated catch block
...
//					}
					break;
				case 3:
					startActivity(new Intent(MainActivity.this, BaoziObj.class));//利用handler更新UI
//					try {
//						Thread.sleep(3000);
//					} catch (InterruptedException e) {
//						// TODO Auto-generated catch block
...
//					}
					break;
				case 4:
					startActivity(new Intent(MainActivity.this, LaotouObj.class));//car OBJ3D文件导入
//					try {
//						Thread.sleep(3000);
//					} catch (InterruptedException e) {
//						// TODO Auto-generated catch block
