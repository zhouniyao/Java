...
//  int texture1;
    ...
    public void setTYPE(int type) {
		...
		case 5:
			break;
		default:
			Toast.makeText(context, "输出类型错误，请选择以下类型：Constant.POINTS、Constant.LINES、FACES",Toast.LENGTH_LONG).show();
			return;
		}
	}
	/**
	...
	public void initObjData(String objResource) {
		...
		int k = 0;
		//通过序列，找到对应坐标
		for (int index55 : faceVerticesSeq ) { //遍历序列
...
//    	GLES20.glDrawElements(GL_Constant.TRIANGLES, obj.numFaces * 3, GL_UNSIGNED_SHORT, objVerticesSeq);//三角面
    	drawObject();
