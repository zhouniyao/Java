	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				switch (arg2) {
				case 0:
					startActivity(new Intent(MainActivity.this, BingMaYong.class));//无纹理测试
					//激活dragon例子
...
//					}
					break;
				case 3:
//					startActivity(new Intent(MainActivity.this, PuSa.class));//利用handler更新UI
//					try {
//						Thread.sleep(3000);
//					} catch (InterruptedException e) {
//						// TODO Auto-generated catch block
...
//					}
					break;
				case 4:
//					startActivity(new Intent(MainActivity.this, LibraryObj.class));//car OBJ3D文件导入
//					try {
//						Thread.sleep(3000);
//					} catch (InterruptedException e) {
//						// TODO Auto-generated catch block
...
//					startActivity(new Intent(MainActivity.this, HighHeelShoePLY.class));//OBJ3D文件导入
					...
					break;
				case 7:
					startActivity(new Intent(MainActivity.this, BezierSurfaceDemo.class));//OBJ3D文件导入
					break;
				default:
					break;
				}
