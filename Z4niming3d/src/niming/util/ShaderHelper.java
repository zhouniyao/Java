...
//		final int shaderObjectID = glCreateShader(type);//新的着色器对象
//		
//		if(shaderObjectID == 0){
//			if(LoggerConfig.ON){
...
//		}
//		
//		// 把着色器源代码上传到着色器对象中，这个调用告诉OpenGL读入字符串shaderCoder定义的源代码，
//			并把它与shaderObjectId所引用的着色器对象关联起来。
//		glShaderSource(shaderObjectID, shaderCode);
//
//		glCompileShader(shaderObjectID);//告诉OpenGL编译上面上传到shaderObiectId源代码。
//		
//		//告诉OpenGL读取与shaderObjectId关联的编译状态，并把它写入compileStatus的第0个元素。
//		final int[] compileStatus = new int[1];
//		glGetShaderiv(shaderObjectID, GL_COMPILE_STATUS, compileStatus, 0);//为了检测编译是否成功
//		
//		if(LoggerConfig.ON){
...
//		final int programObjectId = glCreateProgram();//新的程序对象
//		
