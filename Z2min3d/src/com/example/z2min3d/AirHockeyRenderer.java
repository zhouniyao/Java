...
//		uColorLocation = glGetUniformLocation(program, U_COLOR);//获取uniform的位置，并把这个位置存入uColorLocation中。
		 ...
		 */
		aColorLoaction = glGetAttribLocation(program, A_COLOR);
...
//		glVertexAttribPointer(aPositionLocation, POSITION_COMPONENT_COUNT, GL_FLOAT, false, 0, vertexData);
		...
		glVertexAttribPointer(aColorLoaction, COLOR_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, vertexData);
		//寻找顶点数据
		glEnableVertexAttribArray(aColorLoaction);
		/*3.4 链接工作——结束*/
