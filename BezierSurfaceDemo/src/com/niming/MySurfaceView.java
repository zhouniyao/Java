...
class MySurfaceView extends GLSurfaceView 
{
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            bezier.yAngle += dx * TOUCH_SCALE_FACTOR;//设置填充椭圆绕y轴旋转的角度
            bezier.xAngle+= dy * TOUCH_SCALE_FACTOR;//设置填充椭圆绕x轴旋转的角度
        }
...
//            MatrixState.translate(-1.2f, 0, 0);
            MatrixState.rotate(-180, 1.0f, 0.0f, 0.0f);//不旋转看不见
            bezier.drawSelf();  
   //////////////////////////////////////////////////////////////////////////////
...
//    		Log.i(TAG, "$宽3："+ width + "    " + "$高3：" + height);
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            bezier=new Bezier(MySurfaceView.this);
            //打开深度检测
