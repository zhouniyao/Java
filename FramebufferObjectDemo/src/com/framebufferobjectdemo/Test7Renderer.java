...
public class Test7Renderer implements GLSurfaceView.Renderer
{
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config)
    {
        ...
        // Load the texture
        mTextureDataHandle = ToolsUtil.loadTexture(mActivityContext, R.drawable.wl);
    }
    ...
    public void onDrawFrame(GL10 glUnused)
    {
        ...
        GLES20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0,
                GLES20.GL_TEXTURE_2D, texture.get(0), 0);//纹理附到FBO
	 ...
	 */
        ...
        GLES20.glFramebufferRenderbuffer(GLES20.GL_FRAMEBUFFER, GLES20.GL_DEPTH_ATTACHMENT,
                GLES20.GL_RENDERBUFFER, depthRenderbuffer.get(0));//Renderbuffer附着FBO
