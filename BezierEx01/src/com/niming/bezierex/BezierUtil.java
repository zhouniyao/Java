...
{
   static ArrayList<BNPosition> al=new ArrayList<BNPosition>();	//贝塞尔曲线基于的点的列表[控制点]
   
   public static ArrayList<BNPosition> getBezierData(float span)//求贝塞尔曲线上点序列的方法，span = 1.0f/Constant.FD
   {
	   ...
	   for(int i=0;i<=steps;i++)
	   {
		   ...
		   result.add(new BNPosition(xf,yf));//得到的点存入结果列表
	   }
